...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/jahied/approval.txt/blob/main/Apro.txt"])
	exit(" [*] FACEBOOK :  ROOT.OFF.JAHIED")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN BD JAHIED")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/jahied/approval.txt/blob/main/Apro.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  : +8801747951169
\033[1;90m══════════════════════════════════════════════════
    """)
